...
workflow.set_entry_point("financial_agent") # Por defecto analiza finanzas
# Opcional: Lógica condicional real
# workflow.set_conditional_entry_point(router, {"financial_agent": "financial_agent", "goal_agent": "goal_agent"})
